...
date: '2022-05-10'
image: academic_writting.png
output: html_document
---


When to use comma before but always trips me up. For future reference, I am documenting the general rules for connecting two independent clauses using coordinating conjunctions (e.g., but and is) and Independent Marker Words (e.g., however and also). 
...
2. The team won the game. (subject is team and won is verb)

A dependent clauses (or subordinate clause) is one that cannot stand alone as a complete sentence (i.e., it does not express a complete thought). Dependent clauses must be combined with one or more independent clauses to form a sentence. The following are examples of dependent clauses:
...
There are two ways to connect independent clauses: using coordinating conjunctions and using Independent Marker Word
...
1. I went to the schoo, but I forgot my bag at the airport.
...
### Using Independent Marker Word (conjunctive adverb or a transitional expression)


An independent marker word is a word (e.g., also, consequently, furthermore, however, moreover, nevertheless, and therefore.) that can be use to connect two independent clauses. If the second independent clause has an independent marker word, a semicolon is needed before the independent marker word.
...
5. Tony finished reading three novels this week; in contrast, Joan finished only one novel (Transitional Expression: e.g Incontrast, on the other hand).



## Some common mistakes when connecting independent clauses
...
The problem is that though the two clauses are related, we are not connecting them in the correct way. We cannot use a semicolon there because the clauses are joined by the coordinating conjunction but. We can use either the semicolon there or the conjunction, but not both. The following two options are correct:
...
Sometime, you can replace the comma and coordinating conjunction with a semicolon since the connection between the two independent clauses is clear without the coordinating conjunction.
...
## When Semicolons should replace Commas
