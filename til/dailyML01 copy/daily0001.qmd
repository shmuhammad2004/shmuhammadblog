...
When to use a comma before "but" always trips me up. For future reference, I am documenting the general rules for connecting two independent clauses using coordinating conjunctions (e.g., but and is) and Independent Marker Words (e.g., however and also). 
